...
class MetadataBackend:
    ...
    def _enforce_min_bucket_size(self):
        ...
        for bucket in tqdm(
            ...
            print(f"self.minimum_image_size: {self.minimum_image_size}")
    ...
    def _enforce_resolution_constraints(self, bucket):
        ...
        if self.minimum_image_size is not None:
            ...
            print("enforce_resolution_constraints")
            ...
            print('self.aspect_ratio_bucket_indices[bucket]:', self.aspect_ratio_bucket_indices[bucket])
    ...
    def meets_resolution_requirements(
        ...
        if self.resolution_type == "pixel":
            print(f"width: {width}, height: {height} self.minimum_image_size: {self.minimum_image_size} self.resolution_type: {self.resolution_type} cond={self.minimum_image_size <= width and self.minimum_image_size <= height}")
            return (
