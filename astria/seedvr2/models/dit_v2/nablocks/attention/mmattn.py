...
from astria.seedvr2.common.distributed.ops import gather_heads_scatter_seq, gather_seq_scatter_heads_qkv
from astria.seedvr2.common.utils import safe_pad_operation
from ... import na
from astria.seedvr2.models.dit.attention import SageAttention # FlashAttentionVarlen
...
class NaMMAttention(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.attn = SageAttention() # FlashAttentionVarlen()
