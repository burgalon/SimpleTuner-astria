...
class FluxPipelineWithPulID(
    ...
    def __call__(
        ...
        max_sequence_length: int = 512,
        id_image: Optional[Union[Image.Image, np.ndarray]] = None,
        id_image_embeddings: Optional[torch.Tensor] = None,
        id_image_scale: Optional[float] = 1.0,
        ...
        pul_id_embeddings = id_image_embeddings
        if id_image is not None and pul_id_embeddings is None:
            pul_id_embeddings = self._get_pulid_embeddings(
                id_image,
                device=device,
            )
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                noise_pred = self.transformer(
                    ...
                    return_dict=False,
                    pul_id_embedding=pul_id_embeddings,
                    pul_id_weight=id_image_scale,
                )[0]
