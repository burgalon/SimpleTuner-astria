...
from helpers.models.flux_old.transformer import FluxTransformer2DModelWithMasking
from helpers.models.flux_old.pipeline import FluxPipeline, FluxKontextPipeline
from helpers.models.flux_old.pipeline_controlnet import (
    FluxControlNetPipeline,
    FluxControlPipeline,
)

from helpers.training.multi_process import _get_rank
from helpers.models.flux_old import (
...
class Flux(ImageModelFoundation):
    ...
    def get_lora_target_layers(self):
        ...
        if self.config.lora_type.lower() == "standard":
            ...
            elif self.config.flux_lora_target == 'portrait':
                return [
                    "proj_out",
            ...
            elif self.config.flux_lora_target == '84':
                return [
                    "single_transformer_blocks.0.attn.to_k",
                    "single_transformer_blocks.0.attn.to_q",
                    "single_transformer_blocks.0.attn.to_v",
            ...
            elif self.config.flux_lora_target == '2025':
                return [
                    "single_transformer_blocks.0.attn.to_k",
                    "single_transformer_blocks.0.attn.to_k",
                    "single_transformer_blocks.0.attn.to_q",
