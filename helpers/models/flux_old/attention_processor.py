...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        from helpers.models.flux_old.normalization import FP32LayerNorm, LpNorm, RMSNorm
...
class SanaMultiscaleLinearAttention(nn.Module):
    ...
    def __init__(
        ...
        # To prevent circular import
        from helpers.models.flux_old.normalization import get_normalization
...
class MochiAttention(nn.Module):
    def __init__(
        ...
        super().__init__()
        from helpers.models.flux_old.normalization import MochiRMSNorm
...
class AllegroAttnProcessor2_0:
    ...
    def __call__(
        ...
        if image_rotary_emb is not None and not attn.is_cross_attention:
            from helpers.models.flux_old.embeddings import apply_rotary_emb_allegro
...
class FluxAttnProcessor2_0:
    ...
    def __call__(
        ...
        if image_rotary_emb is not None:
            from helpers.models.flux_old.embeddings import apply_rotary_emb
...
class SD3IPAdapterJointAttnProcessor2_0(torch.nn.Module):
    ...
    def __init__(
        ...
        # To prevent circular import
        from helpers.models.flux_old.normalization import AdaLayerNorm, RMSNorm
